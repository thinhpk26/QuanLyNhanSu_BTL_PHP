...
<body>
    ...
    <div class="RContent">
        <form name="nhap" method="post">
            ...
            <label for="money">Mã Phòng</label>
        ...
        <?php
            ...
            class ADDDoanhSoPhongModel extends QuanLyLuongModel
            {
                ...
                {
                    if (isset($_POST['money_yc'],$_POST['money_ht'], $_POST['dvi'], $_POST['mp'])) {
                    $this->open_db();
        ...
        <form name="nhap2"method="POST">
            <h3>Sửa Doanh Số Phòng</h3>
            <label for="manv_sua">Nhập Mã Phòng cần sửa</label>
            <input type="text"  name="map_sua" required>
        ...
        <?php
            ...
            class UDDSPhongModel extends QuanLyLuongModel
            {
                public static function withDifferentHost($host)
                {
                    $instance = new self();
                ...
                {
                    if (isset($_POST['moneyyc_sua'], $_POST['moneyht_sua'],$_POST['dvi_sua'], $_POST['map_sua'])) {
                    $this->open_db();
        ...
        ?>
        <form name="nhap2"method="POST">
            <h3>Xóa Doanh Số Phòng</h3>
            <label for="manv_sua">Nhập Mã Phòng cần xóa</label>
            <input type="text"  name="map_xoa" required>
