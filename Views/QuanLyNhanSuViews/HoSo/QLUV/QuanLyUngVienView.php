        ...
        <div class="content">
            ...
            <div class="model js-model">
                <form action="direct.php?route=quanlyuv&act=search" method="post" id="ft-form">
                    ...
                    <div class="ft-form-row">
                        <div class="form-row-tit">Tên ứng viên:</div>
                        <input type="text" id="ten-nhan-vien" name="ten-ung-vien" >
                    </div>

                    <div class="ft-form-row">
                        <div class="form-row-tit">Ngày nộp hồ sơ:</div>
                        <input type="date" id="ngay-nop" name="ngay-nop" >
                    </div>
                    ...
                    <div class="ft-form-row">
                        <div class="form-row-tit">Email:</div>
                        <input type="email" id="email" name="email" >
                    </div>

                    <div class="ft-form-row">
                        <div class="form-row-tit">Số điện thoại:</div>
                        <input type="tel" id="sdt" name="sdt" >
                    </div>

                    <div class="ft-form-row">
                        <div class="form-row-tit">Vị trí ứng tuyển:</div>
                        <input type="text" id="vi-tri-ut" name="vi-tri-ut" >
                    </div>
