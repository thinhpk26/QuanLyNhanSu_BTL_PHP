        ...
        <div class="content">
            <form method="post" action="" class="formm">
                <div class="ttcn js-ttcn">
                    <div class="formm-tit">
                        <h1> Thông Tin Nhân Viên Đã nghỉ việc</h1>
                    </div>
                    ...
                    <div class="formm-content">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="ngay-nghi" name="ngay-nghi" value="<?=$row5['ngayNghi']?>" readonly>
                        </div>

                        <div class="form-group">
                            <label for="tuoi">Lý do nghỉ việc:</label>
                            <textarea id="message" name="message" rows="4" cols="50"><?=$row5['lyDo']?></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="hd js-hd">
                    <?php include './QLNVN-LookDsHd.php'; ?>
                </div>
