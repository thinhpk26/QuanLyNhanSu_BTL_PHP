        ...
        <div class="content">
            ...
            <div class="model js-model">
                <form action="index.php?route=quanlynv&act=search" method="post" id="ft-form">
                    ...
                    <div class="ft-form-row">
                        <div class="form-row-tit">Mã Phòng Ban:</div>
            ...
            <?php
                ...
                while($row = mysqli_fetch_array($result)){
                    ...
                    echo "
                    <td>
                    <button class=\"tb-view-button\"><a href=\"./Views/QuanLyNhanSuViews/HoSo/QLNV/ViewInter.php?maNV=".$row['maNV']."\">Xem</a></button>
                    <button class=\"tb-edit-button\"><a href=\"./Views/QuanLyNhanSuViews/HoSo/QLNV/UpdateInter.php?maNV=".$row['maNV']."\">Sửa</a></button>
                    <button class=\"tb-delete-button js-nghi\"><a href=\"./Views/QuanLyNhanSuViews/HoSo/QLNV/QuitInter.php?maNV=".$row['maNV']."\">Nghỉ</a></button>
                    </td>";
                    echo "</tr>";
...
<script>
   function toggleNavCate2() {
    ...
    var NghiButton = document.querySelector('.js-nghi');
    const form = document.querySelector('.js-model');
    var formNoticeNghi = document.querySelector('.js-Notice-NghiViec');
