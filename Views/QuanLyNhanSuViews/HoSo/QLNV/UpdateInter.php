...
<head>
    ...
    <style>
        *{
        ...
        .ttcn > .formm-content2 > .form-group > button{         
...
<div class="container">
        ...
        <div class="content">
            <form method="post" action="../../../../index.php?route=quanlynv&act=update" class="formm" enctype="multipart/form-data">
                <div class="ttcn js-ttcn">
                    ...
                    <div class="formm-content">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="ten-nhan-vien" name="ten-nhan-vien" value="<?=$row['tenNV']?>" >
                        </div>

                        <div class="form-group">
                            <label for="tuoi">Tuổi:</label>
                            <input type="number" id="tuoi" name="tuoi" value="<?=$row['tuoi']?>" >
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="ngay-sinh" name="ngay-sinh"  value="<?=$row['ngaySinh']?>" >
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="dia-chi" name="dia-chi" value="<?=$row['diaChi']?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="trinh-do" name="trinh-do" value="<?=$row['trinhDo']?>">
                        </div>

                        <div class="form-group">
                            <label for="chuyen-mon">Chuyên môn:</label>
                            <input type="text" id="chuyen-mon" name="chuyen-mon" value="<?=$row['chuyenMon']?>">
                        </div>

                        <div class="form-group">
                            <label for="dan-toc">Dân tộc:</label>
                            <input type="text" id="dan-toc" name="dan-toc" value="<?=$row['danToc']?>">
                        </div>

                        <div class="form-group">
                            <label for="quoc-tich">Quốc tịch:</label>
                            <input type="text" id="quoc-tich" name="quoc-tich" value="<?=$row['quocTich']?>">
                        </div>

                        <div class="form-group">
                            <label for="so-cmnd">Số chứng minh nhân dân:</label>
                            <input type="text" id="so-cmnd" name="so-cmnd" value="<?=$row['soCMND']?>">
                        </div>

                        <div class="form-group">
                            <label for="ho-khau">Hộ khẩu:</label>
                            <input type="text" id="ho-khau" name="ho-khau" value="<?=$row['hoKhau']?>">
                        </div>

                        <div class="form-group">
                            <label for="ngan-hang">Ngân hàng:</label>
                            <input type="text" id="ngan-hang" name="ngan-hang" value="<?=$row['nganHang']?>">
                        </div>

                        <div class="form-group">
                            <label for="so-tai-khoan">Số tài khoản:</label>
                            <input type="text" id="so-tai-khoan" name="so-tai-khoan" value="<?=$row['soTK']?>">
                        </div>

                        <div class="form-group">
                            <label for="ma-so-thue">Mã số thuế:</label>
                            <input type="text" id="ma-so-thue" name="ma-so-thue" value="<?=$row['maSoThue']?>">
                        </div>
                    ...
                    <div class="formm-tit2">
                        <h1>Sửa Thông Tin Giấy Tờ Của Nhân Viên</h1>
                    </div>
                    
                    <div class="formm-content2">
                ...
                <div class="sub-button">
                        <input type="submit" name="upbtn" value="Xác nhận">
                </div>
            </form>
        ...
        <script>
            ...
            function openImagePopup(imageURL, title) {
                ...
                popupWindow.document.write('<html><head><title>' + title + '</title></head><body style="margin: 0; padding: 0;"><img src="' + imageURL + '" style="max-width: 100%; max-height: 100%;"></body></html>');
            }
        </script>
</body>
</html>